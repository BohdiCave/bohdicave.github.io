  ...
  return (
    ...
    {type==="skills" ?
      ...
      <table>
        <tr>
          <th>Frontend:</th>
          <td class="first" >HTML5, CSS3, CSS frameworks (Bootstrap, Milligram.io, UI Kit), CSS flexbox, Javascript/JSON, jQuery-AJAX, web/third-party APIs</td>
        </tr>
        <tr>
          <th>Backend:</th>
        ...
        <tr class="last">
          ...
          <td class="last">Python, Java, С/C++, C#, mobile development (Swift/Flutter/React Native, etc.), data science and visualization (GIS, D3.js, Chart.js, others), cybersecurity, and ...</td>
        </tr>
      </table>
      )
    : type==="missions" &&
      ...
      <table>
        <tr>
          <th>Mission:</th>
          <td class="first">To provide software development expertise to individuals and organizations, especially and primarily in the following spheres of interest: environmental protection, arts, and education.</td>
        </tr>
        <tr>
          <th>Vision:</th>
